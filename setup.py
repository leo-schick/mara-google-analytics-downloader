...
def get_long_description():
    with open('README.md') as f:
        return re.sub('!\[(.*?)\]\(docs/(.*?)\)',
                      r'![\1](https://github.com/leo-schick/mara-google-analytics-downloader/raw/master/docs/\2)', f.read())
...
setup(
    ...
    description='Download Google Analytics data in the mara framework',

    long_description=get_long_description(),
    long_description_content_type='text/markdown',

    url='https://github.com/leo-schick/mara-google-analytics-downloader',
